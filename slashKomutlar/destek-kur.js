...
module.exports = {
    ...
    options:[
        ...
        },
        {
            ...
            required:true
              ...
              {
            name:"kapayan",
            description:"Destek talebini kapata bilen rol",
            type:8,
            required:true
        },
        {
    ...
    run: async (client, interaction) => {
        ...
        try{
            ...
            const ticketsilen = options.getRole("kapayan");
            ...
            interaction.reply({content:"Bir hata oluştu<:cross:999958697310695504>",ephemeral:true});
        }  
}
};